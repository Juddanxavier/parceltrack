...
function expressCompatibleBetterAuth(
  req: express.Request,
...
import leadEnhancementsRoutes from './routes/leadEnhancements';
...
// Lead enhancements routes
app.use('/api/lead-enhancements', leadEnhancementsRoutes);
